...
const Category = ({ category, callbackDeletedCategory }) => {
    ...
    const selectedProducts = useSelector(selectProducts[category.id]);
...
console.log(selectedProducts)
    let productsComponents = selectedProducts[category.id].map(prodObject => <Product getEditData={getEditData} onClick={handleCheckbox} product={prodObject} key={prodObject.id} />);
