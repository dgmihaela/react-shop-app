...
function CategoryList() {
    ...
    return (
        ...
        <div className="categoryist">
            ...
            <ModalProduct getProductsData={getProductsData} modalType="PRODUCT" show={showProduct} handleClose={hideModal} endpoint={'http://localhost:9000/products'} dataSelect={select} />
