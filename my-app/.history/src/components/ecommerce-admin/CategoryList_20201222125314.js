...
function CategoryList() {
    ...
    return (
        ...
        <div className="categoryist">
            ...
            <Modal getProductsData={getProductsData} modalType="PRODUCT" show={showProduct} handleClose={hideModal} endpoint={'http://localhost:9000/products'} dataSelect={select} />
