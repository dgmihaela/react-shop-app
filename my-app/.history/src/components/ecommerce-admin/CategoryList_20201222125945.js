...
function CategoryList() {
    ...
    let categoryComponents = select.map(categoryObject => <Category category={categoryObject} key={categoryObject.id} callbackDeletedCategory={callbackDeletedCategory} />);
    return (
        ...
        <div className="categoryist">
            ...
            <ModalProduct callback={getProductsData} modalType="PRODUCT" show={showProduct} handleClose={hideModal} endpoint={'http://localhost:9000/products'} dataSelect={select} />
