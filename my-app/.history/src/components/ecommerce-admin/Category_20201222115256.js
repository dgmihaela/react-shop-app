...
const Category = ({ category, callbackDeletedCategory }) => {
    ...
    let productsComponents = select.map(prodObject => <Product getEditData={getEditData} products={products} onClick={handleCheckbox} product={prodObject} key={prodObject.id} />);
